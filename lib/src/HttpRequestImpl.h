...
namespace xiaoHttp
{
    ...
    public:
        ...
        explicit HttpRequestImpl(xiaoNet::EventLoop *loop)
            : creationDate_(xiaoLog::Date::now()), loop_(loop)
        {
        }
        ...
        const xiaoNet::InetAddress &peerAddr() const override
        {
            return peer_;
        }

        const xiaoNet::InetAddress &localAddr() const override
        {
            return local_;
        }
        ...
        void setCreationDate(const xiaoLog::Date &date)
        {
            creationDate_ = date;
        }

        void setPeerAddr(const xiaoNet::InetAddress &peer)
        {
            peer_ = peer;
        }

        void setLocalAddr(const xiaoNet::InetAddress &local)
        {
            local_ = local;
        }
        ...
        void appendToBuffer(xiaoNet::MsgBuffer *output) const;
    ...
    private:
        ...
        xiaoNet::InetAddress peer_;
        xiaoNet::InetAddress local_;

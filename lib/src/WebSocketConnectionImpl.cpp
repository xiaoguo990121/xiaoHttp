/**
 * @file WebSocketConnectionImpl.cpp
...
const xiaoNet::InetAddress &WebSocketConnectionImpl::localAddr() const
{
    return localAddr_;
}

const xiaoNet::InetAddress &WebSocketConnectionImpl::peerAddr() const
{
    return peerAddr_;
}
...
void WebSocketConnectionImpl::shutdown(
    ...
    const std::string &reason)
{
    ...
    auto c = htos(static_cast<unsigned short>(code));
...
void WebSocketConnectionImpl::forceClose()
{

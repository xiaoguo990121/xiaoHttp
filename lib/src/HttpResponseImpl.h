...
#include <xiaoHttp/Cookie.h>

namespace xiaoHttp
{
    class XIAOHTTP_EXPORT HttpResponseImpl : public HttpResponse
    {
        friend class HttpResponseParser;

    public:
        HttpResponseImpl() : creationDate_(xiaoLog::Date::now())
        {
        }
        ...
        HttpResponseImpl(HttpStatusCode code, ContentType type)
            : statusCode_(code),
              ...
              creationDate_(xiaoLog::Date::now()),
              contentType_(type),
        ...
        const xiaoLog::Date &creationDate() const override
        {
        ...
        std::shared_ptr<xiaoNet::MsgBuffer> renderToBuffer();
        void renderToBuffer(xiaoNet::MsgBuffer &buffer);
        std::shared_ptr<xiaoNet::MsgBuffer> renderHeaderForHeadMethod();
        void clear() override;
        ...
        const xiaoNet::CertificatePtr &peerCertificate() const override
        {
            return peerCertificate_;
        }

        void setPeerCertificate(const xiaoNet::CertificatePtr &cert)
        {
        ...
        {
            fullHeaderString_ = std::make_shared<xiaoNet::MsgBuffer>(128);
    ...
    protected:
        void makeHeaderString(xiaoNet::MsgBuffer &headerString);
    ...
    private:
        ...
        std::shared_ptr<xiaoNet::MsgBuffer> fullHeaderString_;
        xiaoNet::CertificatePtr peerCertificate_;
        mutable std::shared_ptr<xiaoNet::MsgBuffer> httpString_;
